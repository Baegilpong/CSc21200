...
//	1. The dynamic sequence uses a private variable that is a pointer to a value_type called data.
//	2. The current length of the sequence is stored in a private variable called used.
//	3. The current index of the dynamic sequence is stored in a private variable called current_index
//	4. The current capacity of the dynamic sequence is stored in a private variable called capacity.
...
//     new memory) until this capacity is reached.
	...
	// REFERENCED FROM Data Structures and Other Objects Using C++ PAGE 187 bag constructor
...
//     allocating new memory) until this new capacity is reached.
	...
	// REFERENCED FROM Data Structures and Other Objects Using C++ PAGE 193 bag reserve
