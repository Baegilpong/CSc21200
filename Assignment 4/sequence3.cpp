...
// FILE: sequence3.cpp
// Uses sequence2.cpp for Dynamic Array Big-O comparison
// INVARIANT for the sequence class :
//	1. the current item is stored as the cursor
//	2. the previous pointer is stored as the precursor
//  3. if the cursor = head_ptr, then precursor = NULL
//	4. the first node pointer is stored as the head_ptr
//	5. the last node pointer is stored as the tail_ptr
//	6. the number of elements in the list is stored as used
