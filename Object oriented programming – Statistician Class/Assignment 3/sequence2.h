...
namespace main_savitch_4
{
    ...
    private:
        value_type* data;       // pointer to a dynamic array
        size_type used;         // keep track of the current length of the sequence
        size_type current_index;// index to the current item
        size_type capacity;     // keep track of the complete capacity of the dynamic array
    };
